<form id="scheduleFilters" method="GET" action="<?php echo e(route('admin.schedules.index')); ?>" class="row g-3 mb-3">
  <div class="col-md-3">
  ...
  <div class="col-md-6">
    ...
    <input id="scheduleSearch" type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Course, Group, Lecturer, Series, Location" class="form-control" />
  </div>
  <div class="col-md-6 d-flex align-items-end justify-content-end">
    <a href="<?php echo e(route('admin.schedules.index')); ?>" class="btn btn-outline-secondary me-2">Reset</a>
    <button type="submit" class="btn btn-primary">Filter</button>
  </div>
</form><?php /**PATH C:\xampp\htdocs\Attendance Project\Ssendi_Attendance\resources\views/admin/schedules/partials/filters.blade.php ENDPATH**/ ?>