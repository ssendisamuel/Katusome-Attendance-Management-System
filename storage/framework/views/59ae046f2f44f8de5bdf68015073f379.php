...
<html lang="<?php echo e(session()->get('locale') ?? app()->getLocale()); ?>"
    ...
    dir="<?php echo e($configData['textDirection']); ?>" data-skin="<?php echo e($skinName); ?>"
    data-assets-path="<?php echo e(asset('/assets') . '/'); ?>" data-base-url="<?php echo e(url('/')); ?>" data-framework="laravel"
    data-template="<?php echo e($configData['layout']); ?>-menu-template" data-bs-theme="<?php echo e($configData['theme']); ?>"
    <?php if($isAdminLayout && $semiDarkEnabled): ?> data-semidark-menu="true" <?php endif; ?>>
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="<?php echo e(asset('storage/mubslogo.png')); ?>" />
    <link rel="apple-touch-icon" href="<?php echo e(asset('storage/mubslogo.png')); ?>" />
    ...
    <style>
        ...
        .app-brand-logo.demo::before,
        .app-brand-logo.demo::after {
...
<body>
    ...
    <!-- Global SweetAlert Toast for Success Messages -->
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/katusome.ssendi.dev/resources/views/layouts/commonMaster.blade.php ENDPATH**/ ?>