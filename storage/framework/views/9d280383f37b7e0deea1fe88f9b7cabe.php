    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8">
        ...
        <a href="javascript:;" class="app-brand-link">
          ...
          <span
            class="app-brand-text demo menu-text fw-semibold ms-2 ps-1"><?php echo e(config('variables.templateName')); ?></span>
        </a>
      </div>
...
<!-- Navbar: End -->
<?php /**PATH C:\xampp\htdocs\Attendance Project\Ssendi_Attendance\resources\views\layouts\sections\navbar\navbar-front.blade.php ENDPATH**/ ?>