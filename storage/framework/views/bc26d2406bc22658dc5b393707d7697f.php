    ...
    <div class="footer-container d-flex align-items-center justify-content-between py-4 flex-md-row flex-column">
      <div class="mb-2 mb-md-0 d-flex align-items-center gap-3">
        <span>
          ...
          , Developed with ❤️ by <a href="<?php echo e(config('variables.creatorUrl') ?: url('/')); ?>" target="_blank" class="footer-link fw-medium"><?php echo e(config('variables.creatorName', 'Ssendi Samuel')); ?></a>
        </span>
        <?php
...
<!-- / Footer -->
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/katusome.ssendi.dev/resources/views/layouts/sections/footer/footer.blade.php ENDPATH**/ ?>