...
<div class="d-flex justify-content-between align-items-center mb-4">
  ...
  <a href="<?php echo e(route('admin.attendance.create')); ?>" class="btn btn-primary"><span class="icon-base ri ri-add-line me-1"></span>Add Attendance</a>
</div>
