<form id="attendanceFilters" method="GET" action="{{ route('admin.attendance.index') }}" class="row g-3 mb-3">
  <div class="col-md-3">
  ...
  <div class="col-md-6">
    ...
    <input id="attendanceSearch" type="text" name="search" value="{{ request('search') }}" placeholder="Student, Course, Group, Lecturer" class="form-control" />
  </div>
