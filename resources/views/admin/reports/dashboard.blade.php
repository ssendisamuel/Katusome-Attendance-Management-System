  ...
  <div class="row g-6">
    ...
    <div class="col-12">
      <div class="row g-4">
        ...
        <!-- New Reports -->
        <div class="col-12 col-md-6 col-lg-4">
          <a href="{{ route('admin.reports.course') }}" class="text-reset text-decoration-none">
            <div class="card h-100">
              <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                  <span class="icon-base ri ri-book-open-line icon-28px me-2 text-primary"></span>
                  <h5 class="mb-0">Course Report</h5>
                </div>
                <p class="mb-0 text-muted">Analyze attendance by subject/course.</p>
              </div>
            </div>
          </a>
        </div>
        <div class="col-12 col-md-6 col-lg-4">
          <a href="{{ route('admin.reports.group') }}" class="text-reset text-decoration-none">
            <div class="card h-100">
              <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                  <span class="icon-base ri ri-group-line icon-28px me-2 text-info"></span>
                  <h5 class="mb-0">Group Report</h5>
                </div>
                <p class="mb-0 text-muted">Performance of a specific class group.</p>
              </div>
            </div>
          </a>
        </div>
        <div class="col-12 col-md-6 col-lg-4">
          <a href="{{ route('admin.reports.program') }}" class="text-reset text-decoration-none">
            <div class="card h-100">
              <div class="card-body">
                <div class="d-flex align-items-center mb-3">
                  <span class="icon-base ri ri-graduation-cap-line icon-28px me-2 text-success"></span>
                  <h5 class="mb-0">Program Report</h5>
                </div>
                <p class="mb-0 text-muted">High-level program analytics.</p>
              </div>
            </div>
          </a>
        </div>
