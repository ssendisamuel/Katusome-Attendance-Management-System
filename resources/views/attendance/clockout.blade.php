...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">Clock Out — {{ optional($schedule->course)->name }}
            ({{ optional($schedule->course)->code }})</h4>
        <span class="text-muted">{{ $schedule->start_at->format('H:i') }}–{{ $schedule->end_at->format('H:i') }} @
    ...
    <div class="card">
        <div class="card-body">
            <div class="row g-4">
                <div class="col-12 col-md-6">
                    <ul class="list-unstyled mb-4">
                        ...
                        <li><strong>Clocked In At:</strong> {{ $attendance->marked_at->format('H:i') }}</li>
                        ...
                        <svg class="position-absolute top-0 start-0 w-100 h-100" style="pointer-events: none; z-index: 10;"
                            ...
                            <defs>
                                <mask id="scanner-mask">
                                    ...
                                    <!-- Clear Cutout -->
                                    <rect x="22%" y="15%" width="56%" height="70%" rx="30" ry="30"
                                        fill="black" />
                                </mask>
                            </defs>
                    ...
                    <div class="d-flex gap-2">
                        <button id="captureBtn" class="btn btn-warning">Capture Clock-Out</button>
                    </div>
                    ...
                    <div id="previewFallback" class="border rounded p-3 d-none mt-3">
                        ...
                        <div class="d-flex gap-2">
                            <button id="confirmBtnFallback" class="btn btn-success">Confirm Clock-Out</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button id="confirmBtn" class="btn btn-success">Confirm Clock-Out</button>
            ...
            <form id="submitForm" method="POST" action="{{ route('attendance.clockout', $attendance) }}"
      ...
      <div style="background:#fff;padding:16px 20px;border-radius:8px;max-width:420px;text-align:center;box-shadow:0 10px 30px rgba(0,0,0,0.2);">
        ...
        function startOutsideReminder() {
            ...
            outsideReminderTimer = setInterval(() => {
                ...
                const baseMsg = `Move within ${locationLabel} to clock out.`;
        ...
        function updateConfirmState() {
            ...
            if (locationReady && !withinRadius && !outsideNoticeShown) {
                const baseMsg = `Clock-out can only be recorded from within ${locationLabel}.`;
        ...
        console.log('[Clock-Out] Geofence config', {
            campus,
            radiusMeters,
            locationLabel
        });
        ...
        captureBtn.addEventListener('click', (e) => {
            ...
            // Hide scanner container while previewing the captured photo
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        if (response.redirected) {
                            const title = (data && data.message) ? data.message : 'Clock-out recorded!';
                            await Swal.fire({
                                icon: 'success',
                                title,
                                timer: 1500,
