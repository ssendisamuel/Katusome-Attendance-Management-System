        ...
        <ul class="menu-inner">
            ...
            @if ($isAuthenticated)
                @if ($userRole === 'student')
                    ...
                    <li class="menu-item">
                        <a href="#" class="menu-link"
                            onclick="event.preventDefault(); document.getElementById('logout-form-horizontal').submit();">
                            <i class="menu-icon icon-base ri ri-logout-box-r-line"></i>
                            <div>{{ __('Logout') }}</div>
                        </a>
                        <form id="logout-form-horizontal" action="{{ route('logout') }}" method="POST" class="d-none">
                            @csrf</form>
                    </li>
                @elseif($userRole === 'lecturer')
                    ...
                    <li class="menu-item {{ request()->routeIs('lecturer.reports.dashboard') ? 'active' : '' }}">
