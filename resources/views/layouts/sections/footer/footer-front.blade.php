  ...
  <div class="footer-bottom py-5">
    <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
      ...
      <div>
        ...
        @endphp
        @if(!empty($github))
          <a href="{{ $github }}" class="footer-link me-4" target="_blank"><i class="icon-base ri ri-github-fill"></i></a>
        @endif
        @if(!empty($facebook))
          <a href="{{ $facebook }}" class="footer-link me-4" target="_blank"><i class="icon-base ri ri-facebook-circle-fill"></i></a>
        @endif
        @if(!empty($twitter))
          <a href="{{ $twitter }}" class="footer-link me-4" target="_blank"><i class="icon-base ri ri-twitter-x-fill"></i></a>
        @endif
        @if(!empty($youtube))
          <a href="{{ $youtube }}" class="footer-link me-4" target="_blank"><i class="icon-base ri ri-youtube-fill"></i></a>
        @endif
        @if(!empty($linkedin))
          <a href="{{ $linkedin }}" class="footer-link" target="_blank"><i class="icon-base ri ri-linkedin-fill"></i></a>
        @endif
        @if(!empty($instagram))
          <a href="{{ $instagram }}" class="footer-link" target="_blank"><i class="icon-base ri ri-instagram-line"></i></a>
        @endif
      </div>
    </div>
  </div>
