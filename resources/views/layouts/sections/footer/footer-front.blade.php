        ...
        <div
            ...
            <div class="mb-2 mb-md-0">
                <span class="footer-bottom-text">©
                    ...
                    <a href="https://mubs.ac.ug/" target="_blank" class="footer-link text-white">Makerere University
                        Business School</a>. All Rights Reserved.
                </span>
            </div>
            <div>
                <a href="https://mubsep.mubs.ac.ug" target="_blank" class="footer-link me-4 text-white">MUBSEP</a>
                <a href="https://myportal.mubs.ac.ug" target="_blank" class="footer-link text-white">Student Portal</a>
            </div>
        </div>
    </div>
</footer>
