...
@section('content')
            ...
            <form id="formAuthentication" class="mb-5" action="{{ route('register.post') }}" method="POST">
              ...
              <div class="form-floating form-floating-outline mb-5 form-control-validation">
                <input type="email" class="form-control" id="email" name="email"
                  placeholder="e.g., 220003232@mubs.ac.ug" value="{{ old('email') }}" pattern="^[^@\s]+@mubs\.ac\.ug$"
                  title="Email must be a mubs.ac.ug address" required />
              ...
              <div class="form-floating form-floating-outline mb-5 form-control-validation">
                <input type="text" class="form-control" id="student_no" name="student_no"
                  placeholder="Enter your student number" value="{{ old('student_no') }}" required />
                <label for="student_no">Student Number <span class="text-danger">*</span></label>
                @error('student_no')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
              ...
              <div class="form-floating form-floating-outline mb-5 form-control-validation">
                <input type="text" class="form-control" id="reg_no" name="reg_no"
                  placeholder="Enter your registration number" value="{{ old('reg_no') }}" required />
                ...
                <span class="google-icon-chip" aria-hidden="true">
                  <span class="google-icon">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" width="18" height="18"
                      ...
                      <path fill="#4285F4"
                        d="M9 3.6c1.3 0 2.4.5 3.3 1.3l2.4-2.4C13.8.9 11.6 0 9 0 5.3 0 2.2 2.1.9 5.1l2.4 1.9C3.6 5 6.1 3.6 9 3.6z" />
                    </svg>
                  </span>
                </span>
  ...
  <script>
    // Groups are now independent of programs
  </script>
@endsection
