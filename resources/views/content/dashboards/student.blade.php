                            ...
                            <div>
                                ...
                                <div class="time-spending-chart">
                                    <div id="leadsReportChart"
                                        data-total-hours="{{ isset($metrics['timeSpentTotalHours']) ? $metrics['timeSpentTotalHours'] : 0 }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                @if (isset($schedules) &&
                                    ...
                                    @foreach ($schedules as $schedule)
                                        @php
                                            ...
                                            // Can record only if NO record exists, not closed/cancelled, and is active (time or manual)
                                            $canRecord =
                                                !$att && !$isClosed && !$isCancelled && ($manualActive || $withinTime);

                                            // Status Badge Logic (for when no action is available)
                                            $statusBadge = '';
                                            if ($isCancelled) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    ...
                                                    @else
                                                        <span
                                                            class="badge bg-label-secondary">{{ ucfirst($status) }}</span>
                                                    @endif
                                                @endif
                                            </td>
                                        </tr>
                            ...
                            <div class="card h-100 bg-success-subtle">
                                <div class="card-body d-flex align-items-center gap-4">
                                    <div class="avatar avatar-lg">
                                        <div class="avatar-initial rounded bg-white">
                                            <span
                                                class="icon-base ri ri-checkbox-circle-line icon-28px text-success"></span>
                                        </div>
                                    </div>
                                    <div>
...
@section('vendor-script')
    @vite(['resources/assets/vendor/libs/apex-charts/apexcharts.js', 'resources/assets/vendor/libs/datatables-bs5/datatables-bootstrap5.js', 'resources/assets/vendor/libs/moment/moment.js'])
@endsection
