...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('lecturer.attendance.index') }}" class="btn btn-outline-secondary">Back to List</a>
    </div>
    @if ($errors->any())
    ...
    <div id="studentsSection" style="display: none;">
        <form method="POST" action="{{ route('lecturer.attendance.store') }}" id="attendanceForm">
            @csrf
    ...
    <script>
        (function() {
            ...
            function reloadWithFilters() {
                var base = '{{ route('lecturer.attendance.create') }}';
            ...
            scheduleSelect.addEventListener('change', function() {
                ...
                fetch('{{ route('lecturer.attendance.students') }}?schedule_id=' + scheduleId)
                    .then(res => res.json())
                    .then(data => {
