                ...
                <div class="card-body">
                    <form class="row g-4" method="GET" action="{{ route('lecturer.reports.individual') }}">
                        <div class="col-12 col-md-6 position-relative">
                            ...
                            <input type="text" name="student_name" id="studentSearch" class="form-control"
                ...
                <div class="card h-100">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">No records found for this student.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        ...
                        <div class="report-actions">
                            <a href="{{ route('lecturer.reports.individual.export.csv', request()->query()) }}"
                ...
                fetch(url)
                    ...
                    .then(items => {
                        ...
                        items.forEach(item => {
                            ...
                            el.textContent = item.label || (item.name + (item.group ? (' (' + item
                                .group + ')') : ''));
